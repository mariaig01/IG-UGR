...
Muñeco::Muñeco(){
      ...
      cuerpo->ponerNombre("Cuerpo piramide");
      cuerpo->ponerIdentificador(20);
      ...
      pieizq->ponerNombre("Pie izquierdo cubo");
      ...
      piedcha->ponerNombre("Pie derecho cubo");
      ...
      brazos->ponerNombre("Brazos cubo");
      ...
      cuerda->ponerNombre("Cuerda cubo");
      ...
      yoyo->ponerNombre("Yoyo piramide");
