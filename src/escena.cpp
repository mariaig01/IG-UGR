...
void Escena::visualizarGL( )
{
   ...
   // if ( apl->visualizar_normales && !apl->modo_seleccion )
   //      visualizarNormales( );
...
Escena1::Escena1()
{
   ...
   objetos.push_back(new PiramideHeptagonal(2));
   objetos.push_back(new Paralelepipedo());
   objetos.push_back(new PiramideHexagonal(2));
   objetos.push_back(new PrismaHexagonal(2));
   ...
   objetos.push_back(new Trapecio());
   objetos.push_back(new PoligonoRegular(6));
   objetos.push_back(new PrismaPentagonal(3));
   objetos.push_back(new Octaedro());
...
Escena2::Escena2()
{
   ...
   objetos.push_back(new RejillaX(10,10));
   objetos.push_back(new RejillaZ(10,10));
   objetos.push_back(new P2_Malla(1,1));

   //Ejercicios inventados
   objetos.push_back(new Anillo(30,30,0.25,0.2,0.3));
   objetos.push_back(new DobleCono(5,30,1,1));
   objetos.push_back(new ConoTruncado(2,30,1,1,0.5));
   objetos.push_back(new Elipsoide(30,30));
    objetos.push_back(new Botella(30,30));
   objetos.push_back(new SemiEsfera(100,100));
   objetos.push_back( new SemiCilindroBarrido( 10, 30 ) );
   objetos.push_back(new CopaRevol(10,30));
}
...
Escena3::Escena3()
{
   ...
   //Grafos adicionales
   objetos.push_back(new Muñeco2());
   objetos.push_back(new Perro());
   objetos.push_back(new Android());
