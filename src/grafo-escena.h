...
class NodoGrafoEscena : public Objeto3D
{
   ...
   bool centro_calculado = false;     // true si ya se ha calculado el centro del objeto
...
class GrafoEstrellaX : public NodoGrafoEscena
{
   ...
   public:
      ...
      void fijarRotEstrella( const float alpha);
...
class Android : public NodoGrafoEscena
{
   protected:
    ...
    public:
      Android();
      void fijarRotBrazos( const float alpha);
      void fijarRotCabeza( const float alpha);
      unsigned leerNumParametros() const;
      void actualizarEstadoParametro( const unsigned iParam, const float tSec );
...
{
   protected:
      mat4 * pm_tras_coche = nullptr;
      mat4 * pm_rot_rueda = nullptr;
   
   public:
      Coche();
      void fijarRotacionRueda( const float n_alpha );
      void fijarTraslacionCoche( const float n_alpha );
      unsigned leerNumParametros() const;
...
{
   protected: // punteros a matrices
      mat4 * pm_rot1 = nullptr, *pm_rot2 = nullptr, *pm_rot3 = nullptr, *pm_rot4 = nullptr, *pm_rot5=nullptr, *pm_rot6=nullptr;
...
class CuerpoPerro : public NodoGrafoEscena
{
    protected: // punteros a matrices
        mat4 * pm_rot_cola = nullptr;
    public:
        CuerpoPerro();
};
...
class Perro : public NodoGrafoEscena
{
    protected: // punteros a matrices
       mat4 * pm_rot_cola = nullptr;
         mat4 * pm_tras_perro = nullptr;
         mat4 * pm_rot_cabeza = nullptr;
        unsigned num_parametros; // número de parámetros o grados de libertad del objeto
    public:
        Perro();
        void fijarRotacionCola( const float alpha_nuevo );
        void fijarTraslacionPerro( const float alpha_nuevo );
        void fijarRotacionCabeza( const float alpha_nuevo );
...
class Muñeco2 : public NodoGrafoEscena
{
    protected: // punteros a matrices
        mat4 * pm_rot_ojos = nullptr;
        mat4 * pm_rot_cabeza = nullptr;
        mat4 * pm_tras_muñeco = nullptr;
        mat4 * pm_rot_muñeco = nullptr;
    public:
      Muñeco2();
      void fijarRotacionOjos( const float alpha_nuevo );
      void fijarRotacionCabeza( const float alpha_nuevo );
      void fijarTraslacionMuñeco( const float alpha_nuevo );
      unsigned leerNumParametros() const override;
      void actualizarEstadoParametro( const unsigned iParam, const float tSec ) override;
};
...
//------Intento de rotación de objeto sobre si mismo


class Prueba : public NodoGrafoEscena
{
   protected: // punteros a matrices
      mat4 * pm_rot1 = nullptr;
      unsigned num_parametros; // número de parámetros o grados de libertad del objeto
   public:
      void fijarRot1( const float alpha );
      unsigned leerNumParametros() const;
...
//----------------Ruedas que giran sobre si mismas------------

class Ruedas : public NodoGrafoEscena
{
   protected: // punteros a matrices
      mat4 * pm_rot1 = nullptr;
      mat4 * pm_rot2 = nullptr;
      mat4 * pm_rot3 = nullptr;
      mat4 * pm_rot4 = nullptr;
      unsigned num_parametros; // número de parámetros o grados de libertad del objeto
   public:
      void fijarRotacion( const float alpha );
      unsigned leerNumParametros() const;
      void actualizarEstadoParametro( const unsigned iParam, const float tSec );
      Ruedas();
};
...
//---Otro grafo para practicar------
class Casa : public NodoGrafoEscena
{
   protected: // punteros a matrices
      unsigned num_parametros; // número de parámetros o grados de libertad del objeto
      mat4 * pm_rot_puerta = nullptr;
      mat4 * pm_rot_techo = nullptr;
   public:
      void fijarRotPuerta( const float alpha );
      void fijarRotTecho( const float alpha );
      unsigned leerNumParametros() const;
      void actualizarEstadoParametro( const unsigned iParam, const float tSec );
      Casa();
};
