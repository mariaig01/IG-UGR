...
void Cauce::fijarMatrizVista( const glm::mat4 & nue_mat_vista )
{
   ...
   //copia la matriz nue_mat_vista sobre la matriz de vista, que pierde el valor que tuviese antes
   mat_vista = nue_mat_vista ;
   //activa el objeto programa
   glUseProgram( id_prog ); 
   ...
   //fija la matriz de modelada N como igual a la matriz identidad
